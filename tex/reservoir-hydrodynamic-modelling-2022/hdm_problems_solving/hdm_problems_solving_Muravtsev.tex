...
\begin{figure}[H]
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw1}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
		\includegraphics[width=.95\linewidth]{aw1}
	\end{subfigure}
\hfill %выровнять по ширине
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw2}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
		\includegraphics[width=.95\linewidth]{aw2}
	\end{subfigure}
\\[20pt]
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw3}}%
\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
	\centering
	\includegraphics[width=.95\linewidth]{aw3}
\end{subfigure}%
\hfill %выровнять по ширине
\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw4}}%
\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
	\centering
	\includegraphics[width=.95\linewidth]{aw4}
\end{subfigure}
\\[20pt]
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw5}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
		\includegraphics[width=.95\linewidth]{aw5}
	\end{subfigure}
\hfill %выровнять по ширине
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw6}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
...
\begin{figure}[H]
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw7}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
		\includegraphics[width=.95\linewidth]{aw7}
	\end{subfigure}
\hfill %выровнять по ширине
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw8}}%
	\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
		\centering
		\includegraphics[width=.95\linewidth]{aw8}
	\end{subfigure}
\\[20pt]
	\adjustbox{minipage=1.3em}{\subcaption{}\label{fig:aw9}}%
\begin{subfigure}[t]{\dimexpr.5\linewidth-1.3em\relax}
	\centering
