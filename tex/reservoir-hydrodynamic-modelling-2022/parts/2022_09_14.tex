...
\subsection{Вывод уравнения пьезопроводности без упругости пласта (от Шеля)}
...
\begin{enumerate}
	\item $p_0 c_f\ll 1$
	\item $\tilde{\partial}_i\tilde{k}_{ij}\ll 1$
	\item $\dfrac{\partial\tilde{\mu}}{\partial\tilde{p}}\ll 1$
\end{enumerate}

Тогда уравнение \eqref{PiezoEqDiv} перепишется в следующем виде:
\beq
