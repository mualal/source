...
\begin{multline}
\mathcal{L}^{-1}\left(u^L\right)=\frac{J_0\cdot\alpha}{\gamma^2c}\left(\text{sh}\,\gamma ct-\text{sh}\!\left(\gamma c\left(t-\tau\right)\right)-\gamma c\tau\right)e^{-\gamma x}\,+\\+\frac{J_0\cdot\alpha}{\gamma^2c}\left(\text{ch}\!\left(\gamma c\left(t-\tau-\frac{x}{c}\right)\right)-\text{ch}\!\left(\gamma c\left(t-\frac{x}{c}\right)\right)\right)
\end{multline}
